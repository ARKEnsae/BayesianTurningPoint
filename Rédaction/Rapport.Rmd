...
Enfin, il reste à ajouter une spécification pour en compte la dynamique du cycle. Pour cela, on va supposer avoir deux groupes pour la suite de l'analyse. Les séries telles que $S_i = 2$ seront les séries qui mènent le cycle, tandis que les séries pour lesquelles $S_i = 1$ seront les séries qui coïncident avec le cycle. On va donc définir une nouvelle variable $I^*$.
