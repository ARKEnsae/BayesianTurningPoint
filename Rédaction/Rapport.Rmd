...
<!-- rho* permet de généraliser, le met : c'est écrit donc relire pour savoir si c'est clair-->
...
<!-- Corrélation avec le PIB --> Cela conforte les analyses tirées du graphique \@ref(pi-gamma).
...
<!-- pourquoi cohérente ? Traits variables dans le groupe 2. Peut-être faire un exemple-->
...
<!-- Ou l'inverse en terme de proba, ici c'est dans le cas d'un pic -->
...
<!-- ajouter un commentaire sur la difficulté de la prévision en période de covid -->
...
\begin{table}[h]{\centering
   \begin{tabular}{ | c | l | c|}
     ...
     manuf-tppa & Enquête de conjoncture industrie - tendance passée de production & 1\\ \hline
