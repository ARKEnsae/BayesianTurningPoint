...
<!-- Pas compris --> On considéra que $\rho^*=1$ pour le groupe des séries coïncidentes, $\rho^*=2$ pour celles qui mènent le cycle, et toute autre valeur renverra aux séries aux comportements autonomes.
...
<!-- Pas compris le "cette variable semble être plus importante" --> Cela conforte les analyses tirées du graphique \@ref(pi-gamma).
